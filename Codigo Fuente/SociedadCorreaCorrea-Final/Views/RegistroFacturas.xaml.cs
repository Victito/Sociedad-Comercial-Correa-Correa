    ...
    using (var context = new ContextoSMMS())
    {
        ...
        private void MetroWindow_StateChanged(object sender, EventArgs e)
        {
            if (this.WindowState == WindowState.Maximized)
            {
                ...
                NumeroFacturaTextBox.Width = 450;
                Boton.Width = 450;
            }
            else
            {
                RutTextBox.Width = 300;
                NombreSucursal.Width = 300;
                RazonSocialTextBox.Width = 300;
                GiroTextBox.Width = 300;
                DireccionTextBox.Width = 300;
                ComunaTextBox.Width = 300;
                EstadoBox.Width = 300;
                RutVendedorTextBox.Width = 300;
                GiroVendedorTextBox.Width = 300;
                CiudadTextBox.Width = 300;
                EntregarEnTextBox.Width = 300;
                FechaEmisionTextBox.Width = 300;
                VencimientoTextBox.Width = 300;
                CobradorTextBox.Width = 300;
                OrdenDeCompraTextBox.Width = 300;
                CondicionesVentaTextBox.Width = 300;
                GuiaDespachoTextBox.Width = 300;
                NotaVentaTextBox.Width = 300;
                RazonSocialVendedorTextBox.Width = 300;
                NumeroFacturaTextBox.Width = 300;
                Boton.Width = 300; 
            }
        }
    }
